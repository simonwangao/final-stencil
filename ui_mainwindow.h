...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        burningTreeLabel->setText(QCoreApplication::translate("MainWindow", "Let's render some burning trees!", nullptr));
