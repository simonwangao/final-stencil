...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        StemWidthLabel = new QLabel(burningDockContents);
        StemWidthLabel->setObjectName(QString::fromUtf8("StemWidthLabel"));
        StemWidthLabel->setGeometry(QRect(10, 170, 81, 16));
        BranchWidthLabel = new QLabel(burningDockContents);
        BranchWidthLabel->setObjectName(QString::fromUtf8("BranchWidthLabel"));
        BranchWidthLabel->setGeometry(QRect(10, 210, 91, 16));
        StemWidthControl = new QSlider(burningDockContents);
        StemWidthControl->setObjectName(QString::fromUtf8("StemWidthControl"));
        StemWidthControl->setGeometry(QRect(110, 170, 160, 22));
        StemWidthControl->setOrientation(Qt::Horizontal);
        BranchWidthControl = new QSlider(burningDockContents);
        BranchWidthControl->setObjectName(QString::fromUtf8("BranchWidthControl"));
        BranchWidthControl->setGeometry(QRect(110, 210, 160, 22));
        ...
        RandomCactus->setGeometry(QRect(10, 250, 86, 20));
        ...
        StemInput = new QLineEdit(burningDockContents);
        StemInput->setObjectName(QString::fromUtf8("StemInput"));
        StemInput->setGeometry(QRect(270, 170, 61, 21));
        BranchInput = new QLineEdit(burningDockContents);
        BranchInput->setObjectName(QString::fromUtf8("BranchInput"));
        BranchInput->setGeometry(QRect(270, 210, 61, 21));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        StemWidthLabel->setText(QCoreApplication::translate("MainWindow", "Stem Width", nullptr));
